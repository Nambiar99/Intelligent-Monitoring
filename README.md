...
Physical simulations (FEM) are too slow for real-time use. I leveraged Dynamic Mode Decomposition (DMD) to build a linear, reduced-order model directly from time-series data.
